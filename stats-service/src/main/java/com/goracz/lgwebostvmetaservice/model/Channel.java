package com.goracz.lgwebostvmetaservice.model;
...
public class Channel {
    ...
    public Mono<Channel> populateChannelLogo(ChannelMetadata metadata) {
        this.setImgUrl(metadata.getChannelLogoUrl());
