    ...
    dayChannelHistories.forEach((channelHistory) => {
        ...
        for (let i = startHour; i <= endHour; i += 1) {
            ...
            if (
                ...
                duration = moment.unix(channelHistory.end).minute()
                    - moment.unix(channelHistory.start).minute();
            }
...
const DashboardPage: NextPage = () => {
    ...
    useEffect(() => {
        if (tvUptime) {
            if (tvUptime.turnOffTime) {
                ...
                setCalculatedTvUptime(
                    formatUptime(moment(moment().diff(moment.unix(tvUptime.turnOnTime)) - 1000 * 60 * 60).format('H:m:'))
                );
            }
        }
    }, [tvUptime]);
    ...
    return (
        <ApplicationLayout>
            <Grid>
                <Col span={12}>
                    <Card shadow="xl" radius="xl" px={30} py={10}>Filters</Card>
                </Col>
                <Col lg={6} xl={3}>
                    <Card style={{ height: '100%' }} shadow="xl" radius="xl" px={30} pb={30}>
                        ...
                        <Text weight="bold" size={20}>
                            <Group spacing="sm">
                                ...
                                {isLoadingPowerState && <Skeleton height={20} width="10%" />}
                                {!isLoadingPowerState && (
                                    <Badge
                                      variant="gradient"
                                      gradient={
                        ...
                        <Space h="xs" />
                        <Text weight="normal">
                            {isLoadingSoftwareInfo && <Skeleton height={12} mt={6} width="30%" />}
                        ...
                        <Text>
                            <Group position="apart">
                                ...
                                {!softwareInfo &&
                                    <Skeleton height={12} mt={6} width="30%" />}
                                {softwareInfo && (<Text>
                                    {softwareInfo.device_id}
                                                  </Text>)}
                        ...
                        <Text>
                            <Group noWrap position="apart">
                                <Text weight={500} lineClamp={1}>
                                    <Text>
                                        {currentChannel && currentChannel.channelName ? 'Current Channel' : 'Current Application'}
                                    </Text>
                                </Text>
                    ...
                    <Grid>
                        ...
                        <Col lg={12}>
                            <Card style={{ minHeight: '25.5vh' }} shadow="xl" radius="xl" p="xs">
                                ...
                                <Grid columns={4}>
                                    {['YouTube', 'Spotify', 'Tidal', 'Browser', 'RTL+', 'Twitch'].map((application) => (
                                        <Col lg={1} p={20}>
                                            <Card
                                              withBorder
                        ...
                        <Col lg={12}>
                            <Card style={{ minHeight: '30vh' }} shadow="xl" radius="xl" p="xs">
                                ...
                                <Space h="xs" />
                                {(!calculatedHourlyChannelView || (calculatedHourlyChannelView && calculatedHourlyChannelView
