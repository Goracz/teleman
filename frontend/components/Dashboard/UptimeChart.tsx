...
const UptimeChart = ({ calculatedHourlyChannelView, colorScheme, tvUptime }: UptimeChartProps) => (
    ...
    {(!calculatedHourlyChannelView ||
      (calculatedHourlyChannelView &&
        calculatedHourlyChannelView
          ...
          .reduce((acc: number, curr: number) => acc + curr, 0) === 0)) && <UptimeChartSkeleton />}
    {calculatedHourlyChannelView &&
      calculatedHourlyChannelView
        .map((stat: any) => stat.minutes)
          ...
          <ResponsiveContainer width="99%" height={305}>
            ...
            >
              ...
              <XAxis
                ...
                fontWeight={500}
              />
              <YAxis domain={[0, 60]} strokeDasharray="1 1" fontFamily="Poppins" fontWeight={500} />
              <Tooltip
